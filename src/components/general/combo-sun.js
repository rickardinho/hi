...
export default class ComboSun extends Component {
  ...
  render () {
    ...
    const options = [
      { value: 1, label: 1, icon: faCloud },
      { value: 2, label: 2, icon: faCloud },
      { value: 3, label: 3, icon: faCloud },
      { value: 4, label: 4, icon: faCloud },
      { value: 5, label: 5, icon: faCloud },
      { value: 6, label: 6, icon: faCloud },
      { value: 7, label: 7, icon: faCloud },
      { value: 8, label: 8, icon: faCloud },
      { value: 9, label: 9, icon: faCloud },
      { value: 10, label: 10, icon: faCloud }
    ];
        ...
        return (
          ...
          >
            ...
            <div style={{ width: '60%', height: '100%', alignItems: 'center', justifyContent: 'center' }}>
              <FontAwesomeIcon icon={option.icon} size='lg' style={{ color: colours.orange }} />
            </div>
          </button>
