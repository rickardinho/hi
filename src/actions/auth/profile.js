...
export function getUserNoById (token, user_id) {
  return (dispatch) => {
    ...
    fetch(`${process.env.URI}/userNos/${user_id}`, {
      method: 'GET',
      headers: {
...
export function gotItWhatsNew (token, user_id, user_update_no) {
  return (dispatch) => {
    ...
    fetch(`${process.env.URI}/saveUpdateNo/${user_id}`, {
      method: 'PATCH',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
...
export function updateOpenNo (token, user_id, open_no) {
  return (dispatch) => {
    ...
    fetch(`${process.env.URI}/saveOpenNo/${user_id}`, {
      method: 'PATCH',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
...
export function editName (token, user_id, firstname, surname) {
  return (dispatch) => {
    ...
    fetch(`${process.env.URI}/users/${user_id}`, {
      method: 'PATCH',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
